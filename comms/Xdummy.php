...
echo '<p>BEGIN GGGXXXXXXXXXXXXXX </p>';
// Let's start the class
// $serial = new phpSerial;
$serial = new PhpSerial;
echo '<p>SET GGGXXXXXXXXXXXXXX </p>';
...
echo '<p>OPEN GGGXXXXXXXXXXXXXX </p>';
...
$read = '';
// $testvar = '1234';
// echo $testvar . ' test variable ... <br>';
while($read == '') {
    $read = $serial->readPort();
}

echo $read . '... <br>';
echo '<p>READ GGGXXXXXXXXXXXXXX </p>';
